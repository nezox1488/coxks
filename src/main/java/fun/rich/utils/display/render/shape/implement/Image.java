package fun.rich.utils.display.render.shape.implement;
/**
 * @author Sitoku
 * @since 3/3/2026
 */
...
import fun.rich.utils.display.render.shape.Shape;
import fun.rich.utils.display.render.shape.ShapeProperties;
